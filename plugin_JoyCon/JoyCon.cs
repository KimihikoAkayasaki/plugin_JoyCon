...
using static JoyConExCAPI.JoyConExCAPI;
...
[ExportMetadata("Website", "https://github.com/KinectToVR/plugin_JoyCon")]
[ExportMetadata("DependencyLink", "https://github.com/Timocop/JoyConEx/releases")]
...
public class JoyCon : ITrackingDevice
{
    ...
    public DirectoryInfo ConfigFolder => new(Path.Join(Environment.GetFolderPath(
        Environment.SpecialFolder.ApplicationData), "JoyCon"));
